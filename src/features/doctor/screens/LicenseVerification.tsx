...
export function LicenseVerification({ navigation }: any) {
  ...
  const onSubmit = async (formData: any) => {
    ...
    try {
      ...
      Alert.alert(
        "Submission Failed",
        "Could not verify your license. Please check your inputs and try again.",
      );
    } finally {
      setIsLoading(false);
    }
          ...
          >
            ...
            <View style={styles.articleContainer}>
              <Text style={styles.articleText}>
                Your license will be verified by our admin team within 2-3
            ...
            <View style={styles.inputContainer}>
              ...
              <InputField
                ...
                rules={{ required: "Licensing authority is required" }}
              />
            ...
            <View style={styles.warningContainer}>
              ...
              <Text style={styles.warningTextSecondary}>
                Your license document will only be viewed by authorized admin
                staff for verification purposes. It will not be displayed
                publicly.
              </Text>
            </View>
